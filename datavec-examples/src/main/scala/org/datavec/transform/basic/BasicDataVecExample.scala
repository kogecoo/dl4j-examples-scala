  ...
  def main(args: Array[String]): Unit = {
    ...
    val tp = new TransformProcess.Builder(inputDataSchema)
      ...
      .filter(new ConditionFilter(
        new CategoricalColumnCondition("MerchantCountryCode", ConditionOp.NotInSet, Set("USA", "CAN").asJava)))
    ...
    val directory = new ClassPathResource("BasicDataVecExample/exampledata.csv").getFile.getParent //Normally just define your directory like "file:/..." or "hdfs:/..."
