...
object SequenceVectorsTextExample {
  ...
  protected val logger = LoggerFactory.getLogger(SequenceVectorsTextExample.getClass)
  ...
  def main(args: Array[String]) {
     ...
     */
    val sequenceIterator = new AbstractSequenceIterator.Builder[VocabWord](transformer).build
    ...
    */
    val lookupTable: WeightLookupTable[VocabWord] = new InMemoryLookupTable.Builder[VocabWord]().lr(0.025).vectorLength(150).useAdaGrad(false).cache(vocabCache).build
